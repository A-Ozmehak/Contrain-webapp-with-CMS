...
export interface ApiArticlePageArticlePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ArticleTags: Schema.Attribute.Component<'article-sections.tags', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Hero: Schema.Attribute.Component<'article-sections.article-hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNavigationNavigation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Placement: Schema.Attribute.Enumeration<['Seperate', 'About', 'Services']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
  ...
  attributes: {
    Blocks: Schema.Attribute.DynamicZone<
      [
        'blocks.hero',
        'blocks.contact-form',
        'blocks.text-with-background-image',
        'blocks.quote',
        'blocks.slider',
        'blocks.our-services',
        'blocks.rich-text',
        'blocks.printing-form',
        'blocks.about',
        'blocks.skills',
        'blocks.services-large',
        'blocks.services-form',
        'blocks.stacked-slider',
        'blocks.expanding-cards',
        'blocks.title-section',
        'blocks.offert-component',
        'blocks.several-images',
        'blocks.image-and-text',
        'blocks.material',
        'blocks.material-list',
        'blocks.service-title-and-text',
        'blocks.batches',
        'blocks.accordion',
        'blocks.test',
      ]
